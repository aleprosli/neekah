...
/**
 * The Neekah marketplace: layered wedding-invitation designs.
 *
...
class Catalog
{
    ...
    protected const MS = [
        ...
        'ekad-ivory-heirloom' => 'Bunga putih dan bingkai emas pada kertas gading dengan nama berhuruf klasik.',
        'ekad-sage-serenade' => 'Dedaun hijau lembut, tulisan beralun dan butiran emas yang tenang.',
        'ekad-burgundy-editorial' => 'Latar marun pekat dengan nama besar tersusun seperti halaman editorial.',
        'ekad-ivory-minimal' => 'Ruang gading yang lapang, nama sebaris dan aksen emas ringkas.',
        'ekad-sage-medallion' => 'Warna sage dengan medalion halus di tengah bingkai bunga.',
        'ekad-burgundy-bismillah' => 'Jemputan marun dan emas dengan pembuka Bismillah.',
        'ekad-ivory-duet' => 'Nama pengantin bersebelahan dalam bingkai bunga putih.',
        'ekad-sage-noor' => 'Hijau sage, kaligrafi Bismillah dan tipografi klasik.',
        'ekad-burgundy-monogram' => 'Ampersand besar yang lembut di belakang nama pengantin.',
        'ekad-ivory-poetry' => 'Gading berbunga dengan baris puitis dan nama tulisan tangan.',
        'mihrab-mawar' => 'Gerbang mihrab putih berukir dengan jambangan mawar ungu dan marun.',
        'sutera-zaitun' => 'Sutera gading, sampul marun bermeteri, plak renda zaitun dan jambangan bunga berlapis.',
        'lili-kasih' => 'Lili merah jambu dan ilustrasi pengantin di atas kertas putih, dengan babak jemputan yang bergerak lembut.',
        'taman-bulan' => 'Taman malam bercahaya bulan dengan gerbang melur, wisteria dan rama-rama yang terbang di hadapan.',
        'kasih-sutera' => 'Ilustrasi pengantin di bawah gerbang lili merah jambu atas sutera gading, dengan rama-rama berterbangan.',
        'melur-purnama' => 'Bulan purnama di taman malam, dibingkai bunga melur putih dan garisan emas halus.',
    ...
    public static function all(): array
    {
        ...
        return [
            ...
            self::d(51, 'Ekad Ivory Heirloom', 'Floral', 'Classic', false, 'White florals, a gold frame and classic names on ivory paper.',
                ['#F7F0E3', '#EFE4D3', '#4D3A29', '#64462C', '#BB9049', '#E1C691', '#F7F0E3', '#4D3A29', '#64462C', '#9D8465'], [$CG, 'Great Vibes', 'Lora', 'Montserrat'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'ivory', 'artworkLayout' => 1]),
            self::d(52, 'Ekad Sage Serenade', 'Floral', 'Romantic', false, 'Soft sage leaves and flowing calligraphy with gold details.',
                ['#E4E8D8', '#D8DDC8', '#344438', '#415940', '#AD8A4F', '#D5BD8C', '#E4E8D8', '#344438', '#415940', '#77866D'], [$PF, 'Allura', 'Lora', 'Lato'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'sage', 'artworkLayout' => 2]),
            self::d(53, 'Ekad Burgundy Editorial', 'Floral', 'Editorial', true, 'Deep burgundy with an asymmetric editorial type arrangement.',
                ['#650D1C', '#4D0B16', '#F8E8D2', '#F3D3A1', '#DBAA5A', '#F2D899', '#650D1C', '#F8E8D2', '#F3D3A1', '#C79983'], ['Bodoni Moda', 'Great Vibes', $CG, 'Montserrat'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'burgundy', 'artworkLayout' => 3]),
            self::d(54, 'Ekad Ivory Minimal', 'Floral', 'Minimal', false, 'An airy ivory cover with a single-line couple name.',
                ['#F7F0E3', '#EFE4D3', '#4D3A29', '#64462C', '#BB9049', '#E1C691', '#F7F0E3', '#4D3A29', '#64462C', '#9D8465'], ['DM Serif Display', 'Allura', 'Lora', 'Inter'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'ivory', 'artworkLayout' => 4]),
            self::d(55, 'Ekad Sage Medallion', 'Floral', 'Elegant', false, 'Sage botanical paper and a fine gold central medallion.',
                ['#E4E8D8', '#D8DDC8', '#344438', '#415940', '#AD8A4F', '#D5BD8C', '#E4E8D8', '#344438', '#415940', '#77866D'], ['Cinzel', 'Parisienne', $CG, 'Montserrat'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'sage', 'artworkLayout' => 5]),
            self::d(56, 'Ekad Burgundy Bismillah', 'Floral', 'Traditional', true, 'Burgundy and gold with a devotional opening line.',
                ['#650D1C', '#4D0B16', '#F8E8D2', '#F3D3A1', '#DBAA5A', '#F2D899', '#650D1C', '#F8E8D2', '#F3D3A1', '#C79983'], [$CG, 'Great Vibes', $CG, 'Lato'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'burgundy', 'artworkLayout' => 6]),
            self::d(57, 'Ekad Ivory Duet', 'Floral', 'Modern', false, 'A side-by-side couple name inside the white floral frame.',
                ['#F7F0E3', '#EFE4D3', '#4D3A29', '#64462C', '#BB9049', '#E1C691', '#F7F0E3', '#4D3A29', '#64462C', '#9D8465'], [$PF, 'Great Vibes', 'Lora', 'Poppins'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'ivory', 'artworkLayout' => 7]),
            self::d(58, 'Ekad Sage Noor', 'Floral', 'Traditional', false, 'Sage and gold with Bismillah above the names.',
                ['#E4E8D8', '#D8DDC8', '#344438', '#415940', '#AD8A4F', '#D5BD8C', '#E4E8D8', '#344438', '#415940', '#77866D'], [$CG, 'Allura', $CG, 'Montserrat'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'sage', 'artworkLayout' => 8]),
            self::d(59, 'Ekad Burgundy Monogram', 'Floral', 'Luxury', true, 'An oversized gold ampersand behind a burgundy invitation.',
                ['#650D1C', '#4D0B16', '#F8E8D2', '#F3D3A1', '#DBAA5A', '#F2D899', '#650D1C', '#F8E8D2', '#F3D3A1', '#C79983'], ['Playfair Display', 'Great Vibes', $CG, 'Montserrat'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'burgundy', 'artworkLayout' => 9]),
            self::d(60, 'Ekad Ivory Poetry', 'Floral', 'Romantic', false, 'A poetic line and calligraphic names among ivory flowers.',
                ['#F7F0E3', '#EFE4D3', '#4D3A29', '#64462C', '#BB9049', '#E1C691', '#F7F0E3', '#4D3A29', '#64462C', '#9D8465'], [$PF, 'Parisienne', 'Lora', 'Lato'],
                'artwork', 'artwork', 'artwork', 'solid', ['artwork' => 'ivory', 'artworkLayout' => 10]),
            self::d(61, 'Mihrab Mawar', 'Islamic', 'Romantic', false, 'An embossed ivory mihrab framed by airy mauve and burgundy flowers.',
                ['#FCF8F4', '#F3EBE6', '#582832', '#582832', '#8B5363', '#C5A0AA', '#FCF8F4', '#582832', '#582832', '#9D7D86'], [$CG, 'Allura', $CG, 'Montserrat'],
                'mihrab_bloom', 'mihrab_bloom', 'mihrab_bloom', 'solid', ['experience' => 'motion']),
            self::d(62, 'Sutera Zaitun', 'Floral', 'Luxury', true, 'Ivory silk, a burgundy wax-sealed envelope, olive lace and layered wine-coloured blooms.',
                ['#F4EBDD', '#EBDFC9', '#5A1D2C', '#F9E8C7', '#65461F', '#DBBD7C', '#F4EBDD', '#43382D', '#5A1D2C', '#604832'], [$CG, 'Allura', $CG, 'Montserrat'],
                'sutera_zaitun', 'sutera_zaitun', 'sutera_zaitun', 'solid', ['experience' => 'motion']),
            self::d(63, 'Lili Kasih', 'Floral', 'Romantic', false, 'Blush lilies, an illustrated Malay couple and burgundy lettering on airy ivory paper.',
                ['#FBF9F6', '#F5EEE9', '#542636', '#542636', '#854557', '#DDAFB7', '#FBF9F6', '#4D2934', '#542636', '#74505C'], [$CG, 'Allura', 'Lora', 'Montserrat'],
                'lili_kasih', 'lili_kasih', 'lili_kasih', 'solid', ['experience' => 'motion']),
            self::d(64, 'Taman Bulan', 'Floral', 'Romantic', true, 'A moonlit garden with a jasmine-and-wisteria gateway, soft gold details and butterflies in the foreground.',
                ['#15243D', '#0C172C', '#F5EEDC', '#FFF2D2', '#E1C58C', '#F0DAAF', '#15243D', '#F5EEDC', '#FFF2D2', '#E4D6BB'], [$CG, 'Allura', 'Lora', 'Montserrat'],
                'taman_bulan', 'taman_bulan', 'taman_bulan', 'solid', ['experience' => 'motion']),
            self::d(65, 'Kasih Sutera', 'Floral', 'Romantic', true, 'The illustrated couple under a blush lily arch on ivory silk, with butterflies drifting past.',
                ['#F4EBDD', '#EBDFC9', '#4D2934', '#542636', '#7A3A4C', '#DDAFB7', '#F4EBDD', '#43282F', '#542636', '#5E4148'], [$CG, 'Great Vibes', 'Lora', 'Montserrat'],
                'kasih_sutera', 'kasih_sutera', 'kasih_sutera', 'solid', ['experience' => 'motion']),
            self::d(66, 'Melur Purnama', 'Floral', 'Luxury', true, 'A full moon over the night garden, framed by white jasmine and a fine gold line.',
                ['#15243D', '#0C172C', '#F5EEDC', '#FFF2D2', '#E1C58C', '#F0DAAF', '#15243D', '#F5EEDC', '#FFF2D2', '#E4D6BB'], ['Playfair Display', 'Great Vibes', $CG, 'Montserrat'],
                'melur_purnama', 'melur_purnama', 'melur_purnama', 'solid', ['experience' => 'motion']),
            self::d(67, 'Mihrab Kasih', 'Islamic', 'Romantic', false, 'The illustrated couple standing inside an ivory mihrab among mauve and burgundy flowers.',
                ['#FCF8F4', '#F3EBE6', '#582832', '#582832', '#8B5363', '#C5A0AA', '#FCF8F4', '#4D2A32', '#582832', '#9D7D86'], [$CG, 'Parisienne', 'Lora', 'Montserrat'],
                'mihrab_kasih', 'mihrab_kasih', 'mihrab_kasih', 'solid', ['experience' => 'motion']),
            self::d(68, 'Taman Zaitun', 'Floral', 'Elegant', true, 'Sage botanical paper, an olive lace cartouche and burgundy blooms at the corners.',
                ['#E4E8D8', '#D8DDC8', '#344438', '#F9E8C7', '#7D6232', '#DBBD7C', '#E4E8D8', '#2F3D33', '#5A1D2C', '#56644F'], [$CG, 'Allura', $CG, 'Montserrat'],
                'taman_zaitun', 'taman_zaitun', 'taman_zaitun', 'solid', ['experience' => 'motion']),
