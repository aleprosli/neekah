...
class SiteTemplateSeeder extends Seeder
{
    ...
    public static function templates(): array
    {
        return [
            // ── Klasik ────────────────────────────────────────────────────
            self::design('seri-gangsa', 'Seri Gangsa', 'Klasik', ['ms' => 'Kertas krim dengan dakwat marun dan emas.', 'en' => 'Cream paper with maroon and gold ink.'],
            ...
            self::design('gerbang-emas', 'Gerbang Emas', 'Klasik', ['ms' => 'Gambar berbentuk gerbang dengan bingkai emas.', 'en' => 'An arch-shaped photo in a gold frame.'],
            ...
            self::design('bingkai-warisan', 'Bingkai Warisan', 'Klasik', ['ms' => 'Bingkai berganda seperti kad cetak tradisional.', 'en' => 'A double rule, like a traditional printed card.'],
            ...
            self::design('kemboja', 'Kemboja', 'Klasik', ['ms' => 'Putih gading dengan bunga kemboja terapung.', 'en' => 'Ivory white with floating frangipani.'],
            ...
            self::design('songket-diraja', 'Songket Diraja', 'Klasik', ['ms' => 'Kuning diraja dan emas, megah seperti kad istiadat.', 'en' => 'Royal yellow and gold, grand as a state card.'],
            ...
            // ── Islamik ───────────────────────────────────────────────────
            self::design('nur-geometri', 'Nur Geometri', 'Islamik', ['ms' => 'Corak geometri Islam dengan warna teduh.', 'en' => 'Islamic geometry in restful colours.'],
            ...
            self::design('tenun-songket', 'Tenun Songket', 'Islamik', ['ms' => 'Motif songket keemasan atas latar teh.', 'en' => 'Golden songket motifs on a tea-coloured ground.'],
            ...
            self::design('mihrab-nilam', 'Mihrab Nilam', 'Islamik', ['ms' => 'Biru nilam pekat dengan gerbang mihrab keemasan.', 'en' => 'Deep sapphire with a golden mihrab arch.'],
            ...
            // ── Bunga ─────────────────────────────────────────────────────
            self::design('mawar-pagi', 'Mawar Pagi', 'Bunga', ['ms' => 'Merah jambu lembut dengan hujan kelopak.', 'en' => 'Soft pink with a fall of petals.'],
            ...
            self::design('taman-lavender', 'Taman Lavender', 'Bunga', ['ms' => 'Ungu pastel dengan sulur menjalar.', 'en' => 'Pastel purple with trailing vines.'],
            ...
            self::design('kebun-sakura', 'Kebun Sakura', 'Bunga', ['ms' => 'Kelopak sakura berguguran sepanjang kad.', 'en' => 'Sakura petals drifting down the card.'],
            ...
            self::design('bunga-raya', 'Bunga Raya', 'Bunga', ['ms' => 'Merah cerah dan hijau daun, penuh semangat.', 'en' => 'Bright red and leaf green, full of life.'],
            ...
            self::design('daun-hijau', 'Daun Hijau', 'Bunga', ['ms' => 'Hijau sage dengan dedaun berayun.', 'en' => 'Sage green with swaying leaves.'],
            ...
            self::design('bunga-pic', 'Bunga Pic', 'Bunga', ['ms' => 'Pic lembut dan krim, dihiasi bunga pastel.', 'en' => 'Soft peach and cream, dressed in pastel flowers.'],
            ...
            // ── Moden ─────────────────────────────────────────────────────
            self::design('putih-tenang', 'Putih Tenang', 'Moden', ['ms' => 'Putih hangat, dakwat arang, ruang lapang.', 'en' => 'Warm white, charcoal ink, room to breathe.'],
            ...
            self::design('garis-halus', 'Garis Halus', 'Moden', ['ms' => 'Tipografi besar dengan garis penanda nipis.', 'en' => 'Large type with fine marker rules.'],
            ...
            self::design('kanvas-pasir', 'Kanvas Pasir', 'Moden', ['ms' => 'Warna pasir dan tanah, tenang dan moden.', 'en' => 'Sand and earth tones, calm and modern.'],
            ...
            self::design('mozek-kenangan', 'Mozek Kenangan', 'Moden', ['ms' => 'Susunan gambar seperti album.', 'en' => 'Photographs laid out like an album.'],
            ...
            self::design('pita-moden', 'Pita Moden', 'Moden', ['ms' => 'Pita warna melintang sebagai penanda bahagian.', 'en' => 'Bands of colour marking each section.'],
            ...
            self::design('kraf-rustik', 'Kraf Rustik', 'Moden', ['ms' => 'Kertas kraf dan dedaun kering, santai dan hangat.', 'en' => 'Kraft paper and dried leaves, relaxed and warm.'],
            ...
            // ── Malam ─────────────────────────────────────────────────────
            self::design('malam-emas', 'Malam Emas', 'Malam', ['ms' => 'Biru malam dengan emas berkilau.', 'en' => 'Midnight blue with shimmering gold.'],
            ...
            self::design('zamrud', 'Zamrud', 'Malam', ['ms' => 'Hijau zamrud pekat dengan emas lembut.', 'en' => 'Deep emerald with soft gold.'],
            ...
            self::design('marun-malam', 'Marun Malam', 'Malam', ['ms' => 'Marun gelap dengan bunga emas.', 'en' => 'Dark maroon with gold flowers.'],
            ...
            self::design('langit-senja', 'Langit Senja', 'Malam', ['ms' => 'Ungu senja dengan cahaya lembut.', 'en' => 'Dusk purple with a gentle glow.'],
