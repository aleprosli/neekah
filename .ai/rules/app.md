...
Ranking tiers shown to users: New -> Verified -> Trusted -> Top -> Elite. The stored `recommended` identifier remains for compatibility.
Elite Vendor score: rating 30%, completed bookings 20%, completion rate 15%, response rate 15%, platform transactions 10%, profile & catalogue quality 10%. Rating alone must never drive ranking.
