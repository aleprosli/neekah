...
<x-layouts.admin title="Tempahan" heading="Tempahan" subheading="Semua transaksi yang melalui platform.">
    <form method="GET" action="{{ route('admin.bookings.index') }}" class="mb-6 flex flex-col gap-3">
        ...
        <div class="flex gap-2">
            <input type="search" name="q" value="{{ request('q') }}" placeholder="Cari rujukan, vendor atau pengantin…" class="flex-1 rounded-full border border-line bg-surface px-5 py-2.5 text-sm focus:border-brand-400 focus:outline-none">
