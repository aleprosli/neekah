...
@endphp
<svg viewBox="0 0 220 220" fill="none" aria-hidden="true" class="pointer-events-none absolute {{ $flip }} nk-sway {{ $ornamentSize ?? 'w-36 sm:w-48' }} opacity-70" style="animation-delay: {{ $delay }}">
